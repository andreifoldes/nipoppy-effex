...
def run(global_configs,
	...
	if logger is None:
		log_file = f"{log_dir}/{{FC_configs['NAME']}}-{FC_configs['VERSION']}.log"
	...
	preproc_dir = f"{DATASET_ROOT}/derivatives/{preproc_configs['NAME']}/{preproc_configs['VERSION']}/output"
